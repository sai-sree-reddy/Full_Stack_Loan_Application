...
class UpdateApplicationStatus extends React.Component{
    constructor(props){
        super(props);
    ...
    updateApprovedBy=()=>{
        ...
        var c={aid:this.state.aid,approvedBy:this.state.musername};
    ...
    updateApplicationStatus=()=>{
        ...
        var url="http://localhost:8080/updateApplicationStatus/"+this.state.aid+"/"+this.state.approved;
        axios.get(url).then(
            ...
            <div className="container text-center"><br/>
                ...
                <form onSubmit={this.validatePassword} className="container">
                    <fieldset>
                        ...
                        <br/>
                        <input type="password" name="mpassword"  className="text-center form-control"  className="text-center form-control" onChange={this.changeValue} placeholder="Password"/>
                        <br/>
