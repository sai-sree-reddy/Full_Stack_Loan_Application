...
class UpdateLoanInterest extends React.Component{
    constructor(props){
        super(props);
        this.state={lid:"",linterest:"",musername:"",mpassword:"",msg:"",errmsg:""}
    }
    changeValue=(event)=>{
            ...
            <div  className="container text-center">
                ...
                <form onSubmit={this.checkPassword} className="container">
                    <fieldset>
                        ...
                        <input type="text" name="lid" className="text-center form-control"  onChange={this.changeValue} placeholder="Loan ID"/>
                        <br/>
                        <input type="text" className="text-center form-control"  placeholder="Manager Username" name="musername" onChange= {this.changeValue} />
                        <br/>
                        <input type="password" className="text-center form-control"  name="mpassword" onChange={this.changeValue} placeholder="Password"/>
                        <br/>
                        <input type="text"  className="text-center form-control" name="linterest" onChange={this.changeValue} placeholder="Interest Rate"/>
                        <br/>
...
export default UpdateLoanInterest;