...
class DeleteClerkByIdManager extends React.Component{

    constructor(props){
        super(props);
        this.state={
            cusername:this.props.match.params.cusername,
            musername:"",
            ...
            <div className="container text-center">
                ...
                <form onSubmit={this.validatePassword} className="container">
                    <fieldset>
                        ...
                        {/* <input name="cusername" type="text" placeholder="Clerk Username" onChange={this.changeValue}/>
                        <br/> */}
                        <input type="text" placeholder="Manager Username" className="text-center form-control" name="musername" onChange= {this.changeValue} />
                        <br/>
                        <input type="password" placeholder="Manager Password" className="text-center form-control" name="mpassword" onChange={this.changeValue} />
                        <br/>
...
export default DeleteClerkByIdManager;